...
--SELECT * FROM Courses;                          Invalid object name 'Courses'.
-------------------------------
...
-- After the restore completed successfully, we expanded the Databases node in Object Explorer and
--	confirmed that AdventureWorksDW2022 appeared in the list.
