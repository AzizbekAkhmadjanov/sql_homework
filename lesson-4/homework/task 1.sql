...
-------------------------------------------------------------------------
--6. Write a query that uses the WHERE clause to filter for employees with 
...
-------------------------------------------------------------------------
--7. Use ISNULL to replace NULL values in the Email column with the text 
--		"noemail@example.com".From Employees table
...
--     whose Age is either between 30 and 40 or DepartmentName = 'Marketing'.
--SELECT * FROM Employees;
...
--	StockQuantity > 50, sorted by Stock in ascending order.
...
-------------------------------------------------------------------------
--Hard-Level Tasks
--20. Write a query that selects the top 5 products with the highest sales,
--		using TOP(5) and ordered by SaleAmount DESC. 
...
-------------------------------------------------------------------------
--21. Combine FirstName and LastName into one column named FullName in the 
--		Employees table. (only in select statement)
...
-------------------------------------------------------------------------
--22. Write a query to select the distinct Category, ProductName, and Price for 
--	products that are priced above $50, using DISTINCT on three columns.
...
-------------------------------------------------------------------------
--23. Write a query that selects products whose Price is less than 10% of the 
--	average price in the Products table. (Do some research on how to find average
...
-------------------------------------------------------------------------
--25. Use LIKE with wildcard to select all customers whose Email contains 
...
-------------------------------------------------------------------------
--26. Write a query that uses the ALL operator to find employees whose salary
--	is greater than all employees in the 'Sales' department.
...
-------------------------------------------------------------------------
--27. Write a query that filters the Orders table for orders placed in the 
--	last 180 days using BETWEEN and LATEST_DATE in the table. 
