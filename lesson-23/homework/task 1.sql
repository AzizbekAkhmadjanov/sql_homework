...
--CREATE DATABASE HOMETASK23;
--GO
--USE HOMETASK23;

--------------------------------------------------------------------------------
--Puzzle 1: In this puzzle you have to extract the month from the dt column and 
--then append zero single digit month if any. Please check out sample input and 
--		expected output.
...
--------------------------------------------------------------------------------
--Puzzle 2: In this puzzle you have to find out the unique Ids present in the 
--table. You also have to find out the SUM of Max values of vals columns for each 
--Id and RId. For more details please see the sample input and expected output.

--DROP TABLE IF EXISTS MyTabel;
--GO
...
--------------------------------------------------------------------------------
--Puzzle 3: In this puzzle you have to get records with at least 6 characters 
--and maximum 10 characters. Please see the sample input and expected output.

--DROP TABLE IF EXISTS TestFixLengths;
--GO
...
--------------------------------------------------------------------------------
--Puzzle 4: In this puzzle you have to find the maximum value for each Id and 
--then get the Item for that Id and Maximum value. Please check out sample input 
--and expected output.

--DROP TABLE IF EXISTS TestMaximum;
--GO
...
--------------------------------------------------------------------------------
--Puzzle 5: In this puzzle you have to first find the maximum value for each Id 
--and DetailedNumber, and then Sum the data using Id only. Please check out 
--			sample input and expected output.

--DROP TABLE IF EXISTS SumOfMax;
--GO
...
--------------------------------------------------------------------------------
--Puzzle 6: In this puzzle you have to find difference between a and b column 
--between each row and if the difference is not equal to 0 then show the difference 
--i.e. a – b otherwise 0. Now you need to replace this zero with blank.
--Please check the sample input and the expected output.

--DROP TABLE IF EXISTS TheZeroPuzzle;
--GO
...
--        OVER (ORDER BY SaleDate ROWS UNBOUNDED PRECEDING) AS RunningTotalRevenue
--FROM Sales
--ORDER BY SaleDate;
...
--------------------------------------------------------------------------------
--24. Find all products where the selling price is higher than the average 
--		selling price in their category
...
--    SELECT AVG(S2.SellingPrice)
--    FROM Products AS S2
--    WHERE S2.Category = P.Category
--);
