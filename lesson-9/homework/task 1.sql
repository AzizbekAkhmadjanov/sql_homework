...
--		sup.SupplierName 
--FROM Products prod, Suppliers sup;

-------------------------------------------------------------------------
--2. Using Departments, Employees table Get all combinations of departments 
--	and employees.
...
-------------------------------------------------------------------------
--3. Using Products, Suppliers table List only the combinations where the 
--supplier actually supplies the product. Return supplier name and product name
...
------------------------------
--SELECT cus.FirstName + ' ' + cus.LastName CustomerName,
--		o.OrderID
--FROM Orders	o
--JOIN Customers cus
...
-------------------------------------------------------------------------
--11. Using Employees, Departments table List employee names and department
--	names where department IDs are not equal. It means: Show all mismatched 
...
-------------------------------------------------------------------------
--12. Using Orders, Products table Show orders where ordered quantity is 
...
--WHERE sls.SaleAmount>=500;

-----------------------------------
--SELECT CONCAT(cus.FirstName, ' ', cus.LastName) CustomerName,
--	sls.ProductID
--FROM Customers cus
--JOIN Sales sls
--	ON cus.CustomerID= sls.CustomerID
...
-------------------------------------------------------------------------
--19. Using Sales, Customers table Show all sales from customers who are 
--	from 'USA'.
...
--INNER JOIN Customers cus
--	ON o.CustomerID= cus.CustomerID
--WHERE cus.Country= 'Germany' AND o.TotalAmount> 100;
...
-----------------------------------
--SELECT e1.[Name] emp1, 
--		e1.DepartmentID emp1depid,
--		e2.[Name] emp2,
--		e2.DepartmentID emp2depid
--FROM Employees e1
--CROSS JOIN Employees e2
--WHERE e1.[Name]> e2.[Name] AND e1.DepartmentID <> e2.DepartmentID;
...
--		pay.PaymentMethod,
--		o.Quantity * prod.Price ExpecteddAmount
--FROM Payments pay
--INNER JOIN Orders o
--	ON pay.OrderID= o.OrderID
--INNER JOIN Products prod
--	ON o.ProductID= prod.ProductID
--WHERE pay.Amount != (o.Quantity * prod.Price);

-------------------------------------------------------------------------
--23. Using Students, Enrollments, Courses table Find students who are not 
...
-----------------------------------
--SELECT mangs.[Name] ManagerName,
--		mangs.Salary ManagerSalary,
--		emps.[Name] EmployeeName,
--		emps.Salary EmployeeSalary
--FROM Employees emps
--INNER JOIN Employees mangs
--	ON emps.ManagerID= mangs.EmployeeID
--WHERE mangs.Salary<= emps.Salary;

-------------------------------------------------------------------------
--25. Using Orders, Payments, Customers table List customers who have made 
--		an order, but no payment has been recorded for it.
...
-----------------------------------
--SELECT DISTINCT CONCAT(cus.FirstName, ' ', cus.LastName) CustomerName,
--		o.OrderID,
--		pay.OrderID
--FROM Orders o
