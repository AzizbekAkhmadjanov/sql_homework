...
--Task: Display the names of employees who work in either the Sales or 
...
--WHERE cus.Country= 'USA' AND YEAR(o.OrderDate)= 2023;
...
--Task: Display the names of products that are supplied by either Gadget 
...
--Task: For each customer, show their most recent order. Include customers 
...
--Task: Show the customers who have placed an order where the total amount 
--		is greater than 500.
--Tables Used: Orders, Customers
...
--Task: List product sales where the sale was made in 2022 or the sale 
--	amount exceeded 400.
...
-----------------------------------
--SELECT p.ProductName,
--		SUM(s.SaleAmount) TotalSalesAmount
--FROM Sales s
...
--Task: Show the employees who work in the HR department and earn a salary 
--		greater than 60000.
--Tables Used: Employees, Departments
...
--INNER JOIN Departments d
--	ON e.DepartmentID= d.DepartmentID
--WHERE e.Salary> 60000 AND d.DepartmentName= 'Human Resources';

------------------------------------------------------------------------
--12. Return: ProductName, SaleDate, StockQuantity
--Task: List the products that were sold in 2023 and had more than 100 
...
--Task: Show employees who either work in the Sales department or were 
--		hired after 2020.
--Tables Used: Employees, Departments
...
--Task: List all orders made by customers in the USA whose address starts 
--		with 4 digits.
--Tables Used: Customers, Orders
...
--INNER JOIN Orders o
--	ON cus.CustomerID= o.CustomerID
--WHERE cus.Country= 'USA' AND cus.[Address] LIKE '[0-9][0-9][0-9][0-9]%';

------------------------------------------------------------------------
--15. Return: ProductName, Category, SaleAmount
--Task: Display product sales for items in the Electronics category or 
...
--Task: List orders where the customer is from Los Angeles and the order 
...
--INNER JOIN Orders o
--	ON cus.CustomerID= o.CustomerID
--WHERE cus.City= 'Los Angeles' AND o.TotalAmount> 300;

------------------------------------------------------------------------
--18. Return: EmployeeName, DepartmentName
--Task: Display employees who are in the HR or Finance department, or whose 
--	name contains at least 4 vowels.
--Tables Used: Employees, Departments
...
--	OR e.[Name] LIKE '%[euoia]%[euoia]%[euoia]%[euoia]%';

------------------------------------------------------------------------
--19. Return: EmployeeName, DepartmentName, Salary
--Task: Show employees who are in the Sales or Marketing department and 
